...
SimpleStatEditor::SimpleStatEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
SimpleStatEditor::~SimpleStatEditor(){
    
}


void SimpleStatEditor::editorShown (Label*, TextEditor& textEditorShown){
...
Visualizer* SimpleStatEditor::createNewCanvas()
{
    
    SimpleStatProcessor* processor = (SimpleStatProcessor*) getProcessor();

    return new class SimpleStatCanvas(processor);
    
}


void SimpleStatEditor::buttonCallback(Button* button)
{
    SimpleStatProcessor* processor = (SimpleStatProcessor*) getProcessor();
