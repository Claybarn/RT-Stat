...
#ifndef SIMPLESTATEDITOR_H_INCLUDED
#define SIMPLESTATEDITOR_H_INCLUDED
...
class SimpleStatEditor : public VisualizerEditor
{
public:
    
    SimpleStatEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors);
    ...
    SimpleStatProcessor* SimpleStatCanvas;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SimpleStatEditor);
