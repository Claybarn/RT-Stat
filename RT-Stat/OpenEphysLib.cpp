...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
    ...
    //info->name = "RTStatsProcessor";
	info->name = "RTStats"; //Name of the Library, used only for information
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//For processor
		info->processor.name = "RTStats"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<RTStatsProcessor>); //Class factory pointer. Replace "ExampleProcessor" with the name of your class.
		break;
	default:
		return -1;
		break;
