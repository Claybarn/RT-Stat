...
//Was: RTStatsCanvas::RTStatsCanvas(RTStatsProcessor* parentNode) : processor(parentNode)
RTStatsCanvas::RTStatsCanvas(RTStatsProcessor* parentNode) : processor(parentNode)
{
...
void RTStatsCanvas::refreshState(){
    
}


void RTStatsCanvas::update(){
    repaint();
}



void RTStatsCanvas::beginAnimation(){
   startCallbacks();
}


void RTStatsCanvas::endAnimation(){
    stopCallbacks();
}

void RTStatsCanvas::resized(){
...
void RTStatsCanvas::setParameter(int index, float newValue){
    if (index == 0){
        sortedId = newValue;
    }
    else if (index == 1){
...
void RTStatsCanvas::setParameter(int, int, int, float){
    
}

void RTStatsCanvas::paint(Graphics& g){
...
void RTStatsCanvas::refresh(){
    repaint();
    
}


void RTStatsCanvas::comboBoxChanged(ComboBox* c){
...
void RTStatsCanvas::labelTextChanged(Label* labelThatHasChanged){
...
void RTStatsCanvas::buttonClicked(Button* button){
