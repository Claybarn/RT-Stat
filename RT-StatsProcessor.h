...
class RTStatsProcessor : public GenericProcessor
...
private:
    ...
    int64 ticksPerSecond = t.getHighResolutionTicksPerSecond();
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(RTStatsProcessor);
    
};

#endif  // RTStats_H_INCLUDED
